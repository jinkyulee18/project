            ...
            <div className='container about-page'>
                <div className='text-zone'>
                    ...
                    <p className='bio-text'>
                            ...
                            Web Design to the implementation of authorizations server side. I have created projects using with Git: JavaScript,
                            HTML, CSS, SQL, and NoSQL. I am an ambitious student that is determined to learn
